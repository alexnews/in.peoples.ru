...
$pageTitle = 'Заявка артиста — Букинг';
$pageDesc = 'Вы — артист, ведущий, музыкант или спортсмен? Оставьте заявку и мы добавим вас в каталог букинга peoples.ru';
...
<section class="booking-register-hero">
    <div class="container">
        <h1>Вы — артист? Оставьте заявку!</h1>
        <p>Мы помогаем артистам, ведущим, музыкантам и другим известным людям находить заказы на выступления. Заполните простую форму — и мы свяжемся с вами.</p>
    </div>
</section>
